...
public abstract class RecipeRecyclerCursorAdapter
    ...
    private TouchRecipe touchRecipe;

    public RecipeRecyclerCursorAdapter(Cursor c) {
        init(c);
    }
    ...
    public void setTouchRecipe (TouchRecipe  touchRecipe){
        this.touchRecipe = touchRecipe;
    }
}
